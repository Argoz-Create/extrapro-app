export const translations = {
  fr: {
    ...
    "about.missionText": "URJAYA est la solution immédiate pour recruter des extras qualifiés partout en France. Notre mission : résoudre vos urgences de recrutement en quelques minutes, gratuitement — et transformer chaque mise en relation en action solidaire.",
  ...
  en: {
    ...
    "about.missionText": "URJAYA is the instant solution to hire qualified extra staff anywhere in France. Our mission: solve your hiring emergencies in minutes, for free — turning every connection into a solidarity action.",
